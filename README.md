#  Janalta Interview Coding Exercise
...
The application's backend work needs to be written using C#, please ensure you send the full solution file when you submit your exercise.
